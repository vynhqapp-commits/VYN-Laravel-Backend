...
class Invoice extends Model
{
    ...
    protected $fillable = ['tenant_id', 'branch_id', 'customer_id', 'appointment_id', 'coupon_id', 'discount_code', 'invoice_number', 'subtotal', 'discount', 'tax', 'total', 'paid_amount', 'status', 'notes'];
