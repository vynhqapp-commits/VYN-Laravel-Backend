...
class Service extends Model
{
    ...
    protected $fillable = ['tenant_id', 'service_category_id', 'name', 'description', 'duration_minutes', 'price', 'cost', 'is_active'];

    protected $casts = ['is_active' => 'boolean', 'price' => 'decimal:2', 'cost' => 'decimal:2'];
